...
/*   Updated: 2025/07/23 03:00:41 by fernando         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{	
	...
	while (i < simulation->number_of_philosophers)
	{
		...
		if (simulation->argc == 6)
			simulation->philosophers[i].number_of_times_each_philosopher_must_eat = simulation->number_of_times_each_philosopher_must_eat;
